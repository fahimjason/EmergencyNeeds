...
<div class="page-apply">
 ...
 <section class="content">
    <div class="row column medium-10 large-7 xlarge-5">
      <p>We’re seeking a technical dream team who will help us build a future where every person will use Emergency Needs.</p>
      <p>From a technical standpoint, Emergency Needs believes in a future where there are no servers to provision, manage, or scale! Interested candidates can begin following the Serverless Way by exploring the following options:</p>
      <ul>
        <li>Enter our <a href="#" target="_blank">hackathon</a></li>
